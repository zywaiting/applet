...
<head>
    ...
    <base href="https://zhuyao.xin/index/mohuanlizi">
    <title>${title}</title>
    <link rel="stylesheet" href="/love_files/normalize.css">
...
<canvas class="canvas" width="768" height="745"></canvas>
...
<div class="overlay">
    <div class="tabs">
        <div class="tabs-labels"><span class="tabs-label tabs-label--active">Commands</span><span class="tabs-label">Info</span><span
    ...
    var S = {
        init: function () {
            ...
            if (i !== -1) {
                ...
                S.UI.simulate('#circle|${context}|#show', 3000);
            }
...
<%--<div style="display:none">--%>
    ...
    <%--<span id="cnzz_stat_icon_1256580097"><a href="http://www.cnzz.com/stat/website.php?web_id=1256580097"--%>
                                            <%--target="_blank" title="站长统计"><img border="0" hspace="0" vspace="0"--%>
                                                                              <%--src="http://icon.cnzz.com/img/pic1.gif"></a></span>--%>
    <%--<script src=" http://s95.cnzz.com/z_stat.php?id=1256580097&amp;show=pic1" type="text/javascript"></script>--%>
    <%--<script src="http://c.cnzz.com/core.php?web_id=1256580097&amp;show=pic1&amp;t=z" charset="utf-8"--%>
